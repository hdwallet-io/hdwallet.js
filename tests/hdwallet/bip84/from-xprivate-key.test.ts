...
describe("BIP84.fromXPrivateKey", () => {
  it("compressed", () => {
    ...
    const DerivationClass = DERIVATIONS.getDerivationClass(data.BIP84.derivation.name);

    const derivation = new DerivationClass({
      coinType: data.BIP84.derivation.args['coin-type'],
      account: data.BIP84.derivation.args['account'],
      change: data.BIP84.derivation.args['change'] as any,
      address: data.BIP84.derivation.args['address']
    });
