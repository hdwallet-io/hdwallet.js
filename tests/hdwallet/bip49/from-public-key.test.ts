...
describe("BIP49.fromPublicKey", () => {
  it("compressed", () => {
    ...
    }).fromPublicKey(compressed['derivations'][compressed['derivations'].length - 1]['public-key']);
  ...
  it("uncompressed", () => {
    ...
    }).fromPublicKey(uncompressed['derivations'][uncompressed['derivations'].length - 1]['public-key']);
