...
describe("BIP49.fromPrivateKey", () => {
  it("compressed", () => {
    ...
    }).fromPrivateKey(compressed['derivations'][compressed['derivations'].length - 1]['private-key']);
  ...
  it("uncompressed", () => {
    ...
    }).fromPrivateKey(uncompressed['derivations'][uncompressed['derivations'].length - 1]['private-key']);
