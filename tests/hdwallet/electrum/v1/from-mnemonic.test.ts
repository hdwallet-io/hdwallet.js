...
import { ElectrumV1Mnemonic } from '../../../../src/mnemonics';
import { HDS } from '../../../../src/hds';

const data = require('../../../data/json/hdwallet.json') as any;

describe("Electrum-V1.fromMnemonic", () => {
  it("compressed", () => {
    ...
    const hdwallet = new HDWallet(cryptocurrency, {
      ...
      .fromMnemonic(new ElectrumV1Mnemonic(compressed['mnemonic']))
  ...
  it("uncompressed", () => {
    ...
    const hdwallet = new HDWallet(cryptocurrency, {
      ...
      .fromMnemonic(new ElectrumV1Mnemonic(uncompressed['mnemonic']))
      .fromDerivation(new (DERIVATIONS.getDerivationClass(root['derivation']['name']))(
        root['derivation']['args']
      ));
